...
*Heliconia tortuosa* flowers were collected from the field and were brought back to the lab in petri dishes. We then injected a small amount of fuchsin dye into (or right above) the nectar chamber using a syringe with a sharp tip. We used bills replicas that were 3D printed with filament of 4 different hummingbird species (both males and females).
