# Nectar deposition on stigma links trait matching to plant reproductive success

Data, analysis, and documentation for the "Nectar deposition on stigma links trait matching to plant reproductive success" manuscript.

### Licenses

- **Code**: MIT License, see [LICENSE](LICENSE)
- **Data**: Creative Commons Attribution 4.0 International (CC BY 4.0), see [LICENSE-DATA](LICENSE-DATA.txt)
...
- Manuscript Section 2.1: Nectar extraction is not reproducible
...
- Manuscript Section 2.2: Specialist bills deposit nectar on stigma
- Methods Section 4.4: Nectar deposition on stigma

Here we show that nectar dye lands significantly more often on the reproductive structures (and stigma specifically) after being visited by specialist hummingbirds compared to generalist hummingbirds.
...
- Manuscript Section 2.3: Specialist bills improve fruit set
- Methods Section 4.5: Pollination experiment: Simulated visits

Here we show that hand pollinations with simulated specialist hummingbird visits (following their behaviour and morphology) improves fruit set compared to hand pollination with nectar extraction or hand pollination alone.
...
- Manuscript Section 2.4: Pollination requires nectar and bill
- Methods Section 4.6: Mechanism of simulated visits

Here we show that hand pollinations with simulated specialist hummingbird visits (following their behaviour and morphology) has equal fruit set to open pollination and improved fruit set compared to nectar deposition alone, sugar water deposition alone, or bill insertion alone.

![**Manuscript Figure 4:** **Pollination experiment comparing simulated green hermit visits, open pollination, nectar, sugar water, and bill insertion treatments.** Points show the proportion of flowers that developed into fruit (scored as binary yes/no), with error bars representing ± 1 SE of the sample proportion. Sample sizes are indicated above each error bar. Asterisks denote statistically significant differences from the simulated visit treatment (n.s.: p \$ \> \$ 0.05, \*\*: p \< 0.01).](Figures/Poll_Exp_2025_Plot.png)
